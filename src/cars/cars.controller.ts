...
export class CarsController {
    ...
    async getCar(
        ...
        return res.status(HttpStatus.FOUND).json(await this.carService.getCar(carBrand))
    }
    ...
    async updateCar(
        ...
        console.log(carId);
        return res.status(HttpStatus.ACCEPTED).json(await this.carService.patch(carId,body))
